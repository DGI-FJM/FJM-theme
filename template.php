...
switch ($design) {
  ...
  case '3':
    ...
    break;
  case '4':
    drupal_add_css(drupal_get_path('theme', 'fjmtheme') . '/css/custom/turina.css', 'theme', 'all');
    break;
  case '5':
    drupal_add_css(drupal_get_path('theme', 'fjmtheme') . '/css/custom/ensayos.css', 'theme', 'all');
    break;
}
